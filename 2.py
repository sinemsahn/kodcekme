...
if __name__ == '__main__':
    ...
    training_generator_graph = featurextrandnode(malware_paths,malware_attributes)
    ...
    model.fit_generator(
        generator=training_generator_graph,
...
# bu sadece modeli egitme graph donsun kaydettin
